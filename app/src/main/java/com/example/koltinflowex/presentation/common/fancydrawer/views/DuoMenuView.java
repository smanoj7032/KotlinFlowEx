package com.example.koltinflowex.presentation.common.fancydrawer.views;
...
public class DuoMenuView extends RelativeLayout {
    ...
    private int getPrimaryColor() {
        TypedArray typedArray = getContext().obtainStyledAttributes(new TypedValue().data, new int[]{R.attr.dim_green});
     ...
     *
     * @return The adapter currently used to display slot_list in the Menu.
     */
    ...
    /**
     * Sets the slot_list behind this MenuView.
     *
     * @param adapter The Adapter which is responsible for maintaining the
     *                slot_list backing this list and for producing a view to represent an
     *                item in that slot_list set.
     * @see #getAdapter()
     */
