package com.example.koltinflowex.presentation.common.bottomnavigation
...
import com.example.koltinflowex.databinding.MeowNavigationCellBinding
...
class MeowBottomNavigationCell @JvmOverloads constructor(
    ...
    private val binding = DataBindingUtil.inflate<MeowNavigationCellBinding>(
        LayoutInflater.from(context), R.layout.meow_navigation_cell, this, true
    )

    var defaultIconColor = 0
        set(value) {
            field = value
            if (allowDraw) ImageViewCompat.setImageTintList(
                binding.iv,
