...
abstract class RecyclerViewLoadMoreListener(layoutManager: GridLayoutManager) : RecyclerView.OnScrollListener() {
    ...
    private fun checkLoadMore(recyclerView: RecyclerView, dx: Int, dy: Int) {
        ...
        val countItem = linearLayoutManager.itemCount-5
        val firstVisibleItemPosition = linearLayoutManager.findFirstVisibleItemPosition()
        val visibleItemCount = linearLayoutManager.childCount
        val isAtLastItem = firstVisibleItemPosition + visibleItemCount >= countItem
        Log.e("CurrentPage", "checkLoadMore: $firstVisibleItemPosition + $visibleItemCount >= $countItem", )
